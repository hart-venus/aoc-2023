...
fn part2(input: &str) -> String {
    ...
    let mut initial_beams: Vec<Beam> = Vec::new();

    for i in 0..input_matrix[0].len() {
        initial_beams.push(Beam { x: i as i32, y: 0, direction: Direction::Down });
        initial_beams.push(Beam { x: i as i32, y: input_matrix.len() as i32 - 1, direction: Direction::Up });
    }   
    for i in 0..input_matrix.len() {
        initial_beams.push(Beam { x: 0, y: i as i32, direction: Direction::Right });
        initial_beams.push(Beam { x: input_matrix[0].len() as i32 - 1, y: i as i32, direction: Direction::Left });
    }
